          ...
          <div className="flex flex-col gap-3 lg:gap-8">
              ...
              <div className="flex flex-col-reverse gap-3 lg:gap-5 lg:flex-col">
                ...
                <div className="flex items-center gap-3 md:px-4 md:w-screen lg:w-full">
                    <button onClick={rentMovies} className="bg-red-600 w-full py-2 text-white font-semibold rounded-lg">
                        Rent ₹149
                    </button>
                    <button onClick={buyMovies} className="bg-red-600 w-full py-2 text-white font-semibold rounded-lg">
                        Buy ₹599
                    </button>
                </div>
              </div>
