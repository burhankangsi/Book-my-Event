...
import VenueInfo from './VenueDescription';
        ...
        <>
          <div>
             ...
             >
                ...
                <img 
                    src={`https://image.tmdb.org/t/p/original${venue.poster_path}`}
                    alt="poster" 
            ...
            <div className="absolute z-30 left-24 top-10 flex items-center gap-10">
              ...
              <img 
                src={`https://image.tmdb.org/t/p/original${venue.backdrop_path}`}
                alt="poster" 
                className="w-full h-full"
              />
             </div>
